...
public class HangEntity2 extends JFrame implements ActionListener { //Opens up box, implements action listener to
    ...
    public static char[] randomizedWord; //variable for random mystery word
    ...
    public static ArrayList<Character> guessedBefore;
    ...
    public static void Runner1() {
        ...
        randomizedWord = dictionary[(int) (Math.random() * dictionary.length)].toCharArray(); //turns word into individual characters
    ...
    public static void Runner2() {
        ...
        mysteryWord = (dictionary[idx]);//generate random element from array
    ...
    public static void Game() {
        ...
        while (!wordCorrectlyGuessed && limbsLeft > 0) {
            ...
            else if (guessWord.length() != 1 && !mysteryWord.equals(guessWord)){
                correctLetter = true;
            ...
            else if (guessedBefore.contains(newGuess)){
